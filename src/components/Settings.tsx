...
export const Settings: React.FC<SettingsPropsType> = (props) => {
    ...
    const setSettingsCallbackHandler = () => {
        setSettings(startValue, maxValue, '', '', settings.switcher)
    }
    ...
    return (<>
        ...
        <div className={s.settingsParent}>
            ...
            <div>
                <Button name={'Set'} callback={setSettingsCallbackHandler} disabled={setButtonCondition}/>
                {settings.switcher &&
                    <Button name={'Back to counter'} callback={backToCounterCallback} disabled={backButtonCondition}/>
                }
            </div>
        </div>
        </>
